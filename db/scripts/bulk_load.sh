...
--FROM GENERATE_SERIES(10000001, 20000000) seq;
--FROM GENERATE_SERIES(20000001, 30000000) seq;
--FROM GENERATE_SERIES(30000001, 40000000) seq;
--FROM GENERATE_SERIES(40000001, 50000000) seq;
"
